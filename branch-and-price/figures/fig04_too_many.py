...
def explosion_png():
    ...
    ax.set_yscale("log")
    ax.set_xlabel("different widths on the order", fontsize=10, color=TEXT_DIM, labelpad=7)
    ax.set_ylabel("ways to cut one roll", fontsize=10, color=TEXT_DIM, labelpad=7)
    ax.set_xticks(xs)
