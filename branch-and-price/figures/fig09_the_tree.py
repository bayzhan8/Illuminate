...
def tree_png():
    ...
    for node in nodes:
        ...
        ax.plot([x0, x1], [y0 + 0.16, y1 - 0.16], color=MUTED, linewidth=0.9,
                zorder=2)

    colours = {"integral": OK, "pruned": MUTED, "infeasible": MUTED, "open": PLAN}
    for node in nodes:
        x, y = placed[id(node)]
        ...
        ax.text(x, y, text, ha="center", va="center", fontsize=8.5,
                ...
                bbox=dict(boxstyle="square,pad=0.42", facecolor=PAPER,
