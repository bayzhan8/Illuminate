...
""",
    ...
    Sandbox(6, "Change the shelves",
     ...
     "loses its own. A rule with capacity to spare is never paid for.",
...
function draw() {
  ...
  const y = best ? prices(PROFIT, RECIPE, b) : [0, 0, 0];
...
""",
     ...
     "these three sliders can produce one. How many rules get paid varies: "
     "two while the workshop builds both products, one when it builds only one."),
